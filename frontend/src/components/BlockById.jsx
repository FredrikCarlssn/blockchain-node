  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        <label className="mr-2 font-bold text-xl">Enter block hash:</label>
        <input
          className="mr-2 p-2"
          type="text "
          value={id}
        ...
        />
        <button className="w-32 rounded" type="submit">
          Find Block
        </button>
      </form>
      <div></div>
      ...
      {open && (
        <div className="absolute inset-0 bg-black bg-opacity-80 flex items-center justify-center min-h-screen">
